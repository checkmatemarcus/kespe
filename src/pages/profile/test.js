...
import img from "/Users/marcussannes/Documents/repos/kespe/kespe/public/images/115990591-kopi.PNG"

export default function Component() {
    return (
        <>
            <div>
                <div class=" z-10 inline-block flex justify-center px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-20 tooltip dark:bg-gray-700">
                    boobdude
                    <div class="tooltip-arrow" data-popper-arrow></div>
                </div>
                <Image data-tooltip-target="tooltip-jese" class="w-100 h-1000  rounded " src={img} alt="Small avatar" />
            </div>
